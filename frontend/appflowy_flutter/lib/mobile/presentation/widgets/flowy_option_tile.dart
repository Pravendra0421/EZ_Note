  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: FittedBox(
        ...
        child: CupertinoSwitch(
          value: value,
          // Replaced activeTrackColor with trackColor for the inactive state
          trackColor: Theme.of(context).colorScheme.secondary,  // Color for the track when switch is off
          activeColor: Theme.of(context).colorScheme.primary,   // Color for the switch when it's on
          onChanged: onChanged,
        ),
      ),
    );
